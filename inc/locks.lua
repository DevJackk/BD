...
if redis:get(BD.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الحظر والطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."lock_KickBan"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_KickBan"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الحظر والطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:del(BD.."lock_KickBan"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."lock_rdodSource"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_rdodSource"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل  ردود السورس    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:del(BD.."lock_rdodSource"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التحقق    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )        else 
redis:del(BD.."lock_check"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_check"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التحقق    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )        else
redis:set(BD.."lock_check"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else 
                
redis:del(BD.."lock_cleaner"..msg.chat_id_)
local Cleaner = redis:smembers(BD..":IdsMsgsCleaner:"..msg.chat_id_)
for k,v in pairs(Cleaner) do
redis:del(BD..":SetTimerCleaner:"..msg.chat_id_..v) 
Del_msg(msg.chat_id_,v)
end
redis:del(BD..":IdsMsgsCleaner:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_cleaner"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التنظيف التلقائي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )        else
redis:set(BD.."lock_cleaner"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل تاك للكل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."lock_takkl"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_takkl"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل تاك للكل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."lock_takkl"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل المغادره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."lock_leftgroup"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_leftgroup"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل المغادره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:del(BD.."lock_leftgroup"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل الحمايه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."antiedit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."antiedit"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل الحمايه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."antiedit"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."idphoto"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الايدي بالصوره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."idphoto"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."idphoto"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الايدي بالصوره    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."idphoto"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الرابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."lock_linkk"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_linkk"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الرابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."lock_linkk"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_woring"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تفعيل التحذير    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."lock_woring"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_woring"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تعطيل التحذير    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."lock_woring"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_id"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الايدي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."lock_id"..msg.chat_id_) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_id"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الايدي    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:set(BD.."lock_id"..msg.chat_id_,true)  
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."welcome:get"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الترحيب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else redis:set(BD.."welcome:get"..msg.chat_id_,true)  
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."welcome:get"..msg.chat_id_) then 
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الترحيب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:del(BD.."welcome:get"..msg.chat_id_) 
...
local NameUser   = Hyper_Link_Name(data)
redis:mset(
BD.."lock_username"..msg.chat_id_,true,
BD.."mute_gif"..msg.chat_id_,true,
BD.."mute_photo"..msg.chat_id_,true,
BD.."mute_audio"..msg.chat_id_,true,
BD.."mute_voice"..msg.chat_id_,true,
BD.."mute_sticker"..msg.chat_id_,true,
BD.."mute_forward"..msg.chat_id_,true,
BD.."mute_contact"..msg.chat_id_,true,
BD.."mute_location"..msg.chat_id_,true,
BD.."mute_document"..msg.chat_id_,true,
BD.."lock_link"..msg.chat_id_,true,
BD.."lock_tag"..msg.chat_id_,true,
BD.."lock_edit"..msg.chat_id_,true,
BD.."lock_spam"..msg.chat_id_,true,
BD.."lock_bots"..msg.chat_id_,true,
BD.."lock_webpage"..msg.chat_id_,true,
BD.."mute_video"..msg.chat_id_,true,
BD.."mute_inline"..msg.chat_id_,true
)
...
local NameUser   = Hyper_Link_Name(data)
redis:del(
BD.."lock_username"..msg.chat_id_,
BD.."mute_gif"..msg.chat_id_,
BD.."mute_photo"..msg.chat_id_,
BD.."mute_audio"..msg.chat_id_,
BD.."mute_voice"..msg.chat_id_,
BD.."mute_sticker"..msg.chat_id_,
BD.."mute_forward"..msg.chat_id_,
BD.."mute_contact"..msg.chat_id_,
BD.."mute_location"..msg.chat_id_,
BD.."mute_document"..msg.chat_id_,
BD.."lock_link"..msg.chat_id_,
BD.."lock_tag"..msg.chat_id_,
BD.."lock_edit"..msg.chat_id_,
BD.."lock_spam"..msg.chat_id_,
BD.."lock_bots"..msg.chat_id_,
BD.."lock_webpage"..msg.chat_id_,
BD.."mute_video"..msg.chat_id_,
BD..":tqeed_video:"..msg.chat_id_,
BD..":tqeed_photo:"..msg.chat_id_,
BD..":tqeed_gif:"..msg.chat_id_,
BD..":tqeed_fwd:"..msg.chat_id_,
BD..":tqeed_link:"..msg.chat_id_,
BD.."mute_inline"..msg.chat_id_
)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD..":tqeed_video:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفيديو بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:del(BD..":tqeed_video:"..msg.chat_id_)
redis:set(BD..":tqeed_video:"..msg.chat_id_,true)
...
local NameUser   = Hyper_Link_Name(data)
if not msg.Admin then return "🚸*¦ * هذا الامر يخص الادمنيه فقط  \n📛" end
if not redis:get(BD..":tqeed_video:"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المتحركه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:del(BD.."mute_gif"..msg.chat_id_)
redis:set(BD..":tqeed_gif:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD..":tqeed_gif:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح المتحركه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else 
redis:del(BD..":tqeed_gif:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التوجيه بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:del(BD.."mute_forward"..msg.chat_id_)
redis:set(BD..":tqeed_fwd:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD..":tqeed_fwd:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التوجيه  بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else 
redis:del(BD..":tqeed_fwd:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الروابط بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:set(BD..":tqeed_link:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD..":tqeed_link:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الروابط بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else 
redis:del(BD..":tqeed_link:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصور بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:set(BD..":tqeed_photo:"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD..":tqeed_photo:"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصور بالتقييد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else 
redis:del(BD..":tqeed_photo:"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_twasel") then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل التواصل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:set(BD.."lock_twasel",true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."replay"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد تعطيل الردود    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else
redis:del(BD.."replay"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."replay"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد تفعيل الردود    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" )
else 
redis:set(BD.."replay"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفشار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_mmno3"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_mmno3"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفشار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_mmno3"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفارسيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_pharsi"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_pharsi"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفارسيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_pharsi"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الانكليزيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_lang"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_lang"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الانكليزيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_lang"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الروابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_link"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_link"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الروابط    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_link"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_Add"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_Add"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_Add"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التاك (#)    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_tag"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_tag"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التاك (#)    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_tag"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المعرفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_username"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_username"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح المعرفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_username"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التعديل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_edit"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_edit"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التعديل    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_edit"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if   redis:get(BD.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الكلايش    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_spam"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_spam"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الكلايش    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_spam"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التكرار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_flood"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_flood"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التكرار    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_flood"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البوتات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_bots"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_bots"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح البوتات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_bots_by_kick"..msg.chat_id_)
redis:del(BD.."lock_bots"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_join"..msg.chat_id_,true)
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم قفل الاضافه بنجاح   \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_join"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاضافه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_join"..msg.chat_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم فتح الاضافه بنجاح   \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
end
end,{msg=msg})
end
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الماركدوان    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_markdown"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_markdown"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الماركدوان    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_markdown"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الويب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_webpage"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_webpage"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الويب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_webpage"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_gif"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل المتحركه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_gif"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_gif"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_game"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_game"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الالعاب    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_game"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الانلاين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_inline"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_inline"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الانلاين    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_inline"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الدردشه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_text"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_text"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الدردشه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_text"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_photo"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_photo"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_photo"..msg.chat_id_)then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصور    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_photo"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الفيديو    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_video"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_video"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الفيديو    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_video"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الصوت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_audio"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_audio"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الصوت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_audio"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البصمات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_voice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_voice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح البصمات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_voice"..msg.chat_id_)
...
if   redis:get(BD.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الملصقات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_sticker"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_sticker"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الملصقات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_sticker"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الجهات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_contact"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_contact"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الجهات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_contact"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_forward"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التوجيه    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_forward"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_forward"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الموقع    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_location"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_location"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الموقع    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_location"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الملفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_document"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_document"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الملفات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_document"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الاشعارات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_tgservice"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_tgservice"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الاشعارات    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_tgservice"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل الكيبورد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."mute_keyboard"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."mute_keyboard"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح الكيبورد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."mute_keyboard"..msg.chat_id_)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_bots_by_kick"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل البوتات بالطرد    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_bots"..msg.chat_id_,true)
redis:set(BD.."lock_bots_by_kick"..msg.chat_id_,true)
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_bots_by_kick"..msg.chat_id_) then
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if redis:get(BD.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔒¦ تم بالتأكيد قفل التثبيت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else
redis:set(BD.."lock_pin"..msg.chat_id_,true) 
...
msg = arg.msg 
local NameUser   = Hyper_Link_Name(data)
if not redis:get(BD.."lock_pin"..msg.chat_id_) then
return sendMsg(msg.chat_id_,msg.id_,"🔓¦ تم بالتأكيد فتح التثبيت    \n📮¦ بواسطه ⋙「 "..NameUser.." 」 \n✓" ) 
else 
redis:del(BD.."lock_pin"..msg.chat_id_)
