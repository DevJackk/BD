...
local function iBD(msg,MsgText)

if msg.forward_info_ then return false end


if msg.Director 
and (redis:get(jack..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(jack..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(jack..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) 
or redis:get(jack..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)) and MsgText[1] ~= "الغاء" then 
return false end 
print(MsgText[1] )
print(MsgText[2] )
...
if not redis:get(jack..'group:add'..msg.chat_id_) then return sendMsg(msg.chat_id_,msg.id_,'📮¦ بواسطه ⋙「 '..NameUser..' 」 \n📬¦ المجموعه بالتأكيد ✓️ تم تعطيلها \n✓️') end  
...
if redis:get(jack..'lock_id'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)

local msgs = redis:get(jack..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
...
local edited = (redis:get(jack..':edited:'..arg.chat_id_..':'..arg.sender_user_id_) or 0)
...
..'📋¦ رسائلك •⊱ {'..arg.msgs..'} ⊰•\n➖'
local Kleshaidinfo = redis:get(jack..":infoiduser_public:"..arg.chat_id_) or redis:get(jack..":infoiduser")  

if Kleshaidinfo then 
local points = redis:get(jack..':User_Points:'..arg.chat_id_..arg.sender_user_id_) or 0
...
KleshaID = KleshaID:gsub("{البوت}",redis:get(jack..':NameBot:'))
KleshaID = KleshaID:gsub("{المطور}",SUDO_USER)
end
if redis:get(jack.."idphoto"..msg.chat_id_) then
...
local GroupName = (redis:get(jack..'group:name'..arg.ChatID) or '')
redis:set(jack..'linkGroup'..arg.ChatID,(data.invite_link_ or ""))
...
if not msg.Director and redis:get(jack..'lock_pin'..msg.chat_id_) then
...
function(arg,data)
if data.ID == "Ok" then
redis:set(jack..":MsgIDPin:"..arg.ChatID,arg.reply_id)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not msg.Director and redis:get(jack..'lock_pin'..msg.chat_id_) then return "لا يمكنك الغاء التثبيت الامر مقفول من قبل الاداره" end
...
elseif redis:sismember(jack..':SUDO_BOT:',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المطور\n🛠") 
elseif redis:sismember(jack..':FASSTAS_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(jack..':FASSTAS_Group:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(jack..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(jack..'admins:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تقييد الادمن\n🛠") 
elseif  redis:sismember(jack..'whitelist:'..arg.ChatID,UserID) then 
...
redis:set(jack..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
if data.status_.ID == "ChatMemberStatusMember" then 
Restrict(arg.ChatID,arg.UserID,1)  
sredis:set(jack..":TqeedUser:"..arg.ChatID..arg.UserID,true)
...
elseif redis:sismember(jack..':FASSTAS_BOT:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المنشئ\n🛠") 
elseif redis:sismember(jack..':FASSTAS_Group:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك نقييد المنشئ الاساسي\n🛠") 
elseif redis:sismember(jack..'owners:'..msg.chat_id_,UserID) then 
return sendMsg(msg.chat_id_,msg.id_,"👤*¦* لا يمكنك تقييد المدير\n🛠") 
elseif redis:sismember(jack..'admins:'..msg.chat_id_,UserID) then 
...
redis:del(jack..":TqeedUser:"..arg.ChatID..UserID)
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
...
redis:del(jack..":TqeedUser:"..arg.ChatID..arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم فك تقييده  من المجموعه \n✓") 
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(jack..'whitelist:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مميز  في المجموعه \n✓") 
else
redis:hset(jack..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jack..'whitelist:'..arg.ChatID,arg.UserID)
...
if redis:sismember(jack..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مميز  في المجموعه \n✓") 
end
redis:hset(jack..'username:'..UserID,'username',UserName)
redis:sadd(jack..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jack..'whitelist:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓") 
else
redis:srem(jack..'whitelist:'..arg.ChatID,arg.UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(jack..'whitelist:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مميز  في المجموعه \n✓")
else
redis:srem(jack..'whitelist:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مميز  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(jack..'owners:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مدير  في المجموعه \n✓")
else
redis:hset(jack..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jack..'owners:'..arg.ChatID,UserID)
...
UserName = arg.UserName
if redis:sismember(jack..'owners:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مدير  في المجموعه \n✓")
else
redis:hset(jack..'username:'..UserID, 'username',UserName)
redis:sadd(jack..'owners:'..arg.ChatID,UserID)
...
if not redis:sismember(jack..'owners:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓") 
else
redis:srem(jack..'owners:'..arg.ChatID,arg.UserID)
...
if not redis:sismember(jack..'owners:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مدير  في المجموعه \n✓")  
else
redis:srem(jack..'owners:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مدير  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if redis:sismember(jack..':FASSTAS_BOT:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ  في المجموعه \n✓") 
else
redis:hset(jack..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jack..':FASSTAS_BOT:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(jack..':FASSTAS_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ  في المجموعه \n✓") 
else
redis:hset(jack..'username:'..UserID,'username',UserName)
redis:sadd(jack..':FASSTAS_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(jack..':FASSTAS_BOT:'..arg.ChatID,arg.UserID) then
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
else
redis:srem(jack..':FASSTAS_BOT:'..arg.ChatID,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(jack..':FASSTAS_BOT:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ  في المجموعه \n✓") 
else
redis:srem(jack..':FASSTAS_BOT:'..arg.ChatID,UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
ReUsername = ResolveUserName(data)
NameUser   = Hyper_Link_Name(data)
if redis:sismember(jack..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته ادمن  في المجموعه \n✓") 
else
redis:hset(jack..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jack..'admins:'..arg.ChatID,arg.UserID)
...
UserName = arg.UserName
if redis:sismember(jack..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته ادمن  في المجموعه \n✓") 
else
redis:hset(jack..'username:'..UserID,'username',UserName)
redis:sadd(jack..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته ادمن  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
if not redis:sismember(jack..'admins:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
else
redis:srem(jack..'admins:'..arg.ChatID,arg.UserID)
...
local UserID = data.id_
UserName = Flter_Markdown(arg.UserName)
if not redis:sismember(jack..'admins:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله ادمن  في المجموعه \n✓") 
else
redis:srem(jack..'admins:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله ادمن  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
...
local maseegs = redis:get(jack..'msgs:'..arg.UserID..':'..arg.ChatID) or 1
local edited = redis:get(jack..':edited:'..arg.ChatID..':'..arg.UserID) or 0
local content = redis:get(jack..':adduser:'..arg.ChatID..':'..arg.UserID) or 0
...
NameUser = Hyper_Link_Name(data)
local maseegs = redis:get(jack..'msgs:'..UserID..':'..arg.ChatID) or 1
local edited = redis:get(jack..':edited:'..arg.ChatID..':'..UserID) or 0
local content = redis:get(jack..':adduser:'..arg.ChatID..':'..UserID) or 0
...
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
GetUserID(UserID,function(arg,data)
if msg.SudoBase then redis:srem(jack..'gban_users',arg.UserID)  end 
Restrict(arg.ChatID,arg.UserID,2)
redis:srem(jack..'banned:'..arg.ChatID,arg.UserID)
StatusLeft(arg.ChatID,arg.UserID)
redis:srem(jack..'is_silent_users:'..arg.ChatID,arg.UserID)
NameUser = Hyper_Link_Name(data)
...
local UserID = data.id_
if UserID == our_id then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* لا يمكنك تنفيذ الامر بالرد ع رسالة البوت \n📛") end
if msg.SudoBase then redis:srem(jack..'gban_users',UserID)  end 
Restrict(arg.ChatID,UserID,2)
redis:srem(jack..'banned:'..arg.ChatID,UserID)
StatusLeft(arg.ChatID,UserID)
redis:srem(jack..'is_silent_users:'..arg.ChatID,UserID)
NameUser = Hyper_Link_Name(data)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم رفع القيود ان وجد  \n✓") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then
if msg.SudoBase then redis:srem(jack..'gban_users',MsgText[2])  end 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not msg.Creator and not redis:get(jack.."lock_KickBan"..msg.chat_id_) then return "📛*¦* الامر معطل من قبل اداره المجموعة  \n🚶" end
...
NameUser = Hyper_Link_Name(data)
USERNAME = ResolveUserName(data)
if redis:sismember(jack..'banned:'..arg.ChatID,arg.UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه \n✓") 
end

redis:hset(jack..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(jack..'banned:'..arg.ChatID,arg.UserID)
...
if redis:sismember(jack..'banned:'..arg.ChatID,UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره  من المجموعه \n✓") 
end
kick_user(UserID,arg.ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
redis:hset(jack..'username:'..arg.UserID, 'username',arg.UserName)
redis:sadd(jack..'banned:'..arg.ChatID,arg.UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم حظره  من المجموعه \n✓") 
...
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(jack..'username:'..arg.UserID,'username',USERNAME)
redis:setex(jack..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,500,NameUser)
redis:setex(jack..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,500,arg.UserID)
...
NameUser = Hyper_Link_Name(data)
if data.type_.ID == "ChannelChatInfo" then return sendMsg(arg.ChatID,arg.MsgID,"👤*¦* عذرا هذا معرف قناة وليس حساب \n📛") end
redis:hset(jack..'username:'..UserID,'username',arg.USERNAME)
redis:setex(jack..":uploadingsomeon:"..arg.ChatID..msg.sender_user_id_,500,NameUser)
redis:setex(jack..":uploadingsomeon2:"..arg.ChatID..msg.sender_user_id_,500,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📇¦  » حسننا الان ارسل صلاحيات المشرف :\n\n¦1- صلاحيه تغيير المعلومات\n¦2- صلاحيه حذف الرسائل\n¦3- صلاحيه دعوه مستخدمين\n¦4- صلاحيه حظر وتقيد المستخدمين \n¦5- صلاحيه تثبيت الرسائل \n¦6- صلاحيه رفع مشرفين اخرين\n\n¦[*]- لرفع كل الصلاحيات ما عدا رفع المشرفين \n¦[**] - لرفع كل الصلاحيات مع رفع المشرفين \n\n🚸¦ يمكنك اختيار الارقام معا وتعيين الكنيه للمشرف في ان واحد مثلا : \n\n¦ 136 الحلم الاسود\n📬") 
end,{ChatID=msg.chat_id_,MsgID=msg.id_,USERNAME=MsgText[2]})
...
GetChatMember(arg.ChatID,arg.UserID,function(arg,data)
if (data.status_.ID == "ChatMemberStatusKicked" or redis:sismember(jack..'banned:'..arg.ChatID,arg.UserID)) then
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jack..'banned:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره  من المجموعه \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره  من المجموعه \n✓") 
end
...
USERNAME = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(jack..'is_silent_users:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه \n✓") 
else
redis:hset(jack..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(jack..'is_silent_users:'..arg.ChatID,arg.UserID)
...
if redis:sismember(jack..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد كتمه  من المجموعه \n✓") 
else
redis:hset(jack..'username:'..UserID,'username',UserName)
redis:sadd(jack..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم كتمه  من المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
elseif MsgText[2] and MsgText[2]:match('^%d+$') then 
...
if not redis:sismember(jack..'is_silent_users:'..arg.ChatID,arg.UserID) then 
...
UserName = arg.UserName
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jack..'is_silent_users:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء كتمه  من المجموعه \n✓") 
else
redis:srem(jack..'is_silent_users:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء كتمه  من المجموعه \n✓") 
...
redis:setex(jack..'WiCmdLink'..msg.chat_id_..msg.sender_user_id_,500,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل  رابط مجموعتك 🍃'
end

if MsgText[1] == "انشاء رابط" then
if not msg.Creator then return "📛*¦* هذا الامر يخص {المطور,المنشئ الاساسي ,المنشئ} فقط  \n🚶" end
if not redis:get(jack..'ExCmdLink'..msg.chat_id_) then
local LinkGp = ExportLink(msg.chat_id_)
if LinkGp then
LinkGp = LinkGp.result
redis:set(jack..'linkGroup'..msg.chat_id_,LinkGp)
redis:setex(jack..'ExCmdLink'..msg.chat_id_,120,true)
...
if not redis:get(jack.."lock_linkk"..msg.chat_id_) then return "📡*¦* الامر معطل من قبل الادارة \n^"  end
if not redis:get(jack..'linkGroup'..msg.chat_id_) then return "📡*¦* اوه 🙀 لا يوجد رابط ☹️\n🔖*¦*لانشاء رابط ارسل { انشاء رابط } \n📡" end
local GroupName = redis:get(jack..'group:name'..msg.chat_id_)
local GroupLink = redis:get(jack..'linkGroup'..msg.chat_id_)
return "📬¦ رابـط الـمـجـمـوعه 💢\n🌿¦ "..Flter_Markdown(GroupName).." :\n\n["..GroupLink.."]\n"
end

if MsgText[1] == "ضع القوانين" then
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jack..'rulse:witting'..msg.sender_user_id_,300,true)
return '📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل القوانين  للمجموعه 🍃'
end

if MsgText[1] == "القوانين" then
if not redis:get(jack..'rulse:msg'..msg.chat_id_) then 
return "📡*¦* مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه\n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n"
else 
return "*🔖¦القوانين :*\n"..redis:get(jack..'rulse:msg'..msg.chat_id_) 
end 
end
...
redis:set(jack..'num_msg_max'..msg.chat_id_,MsgText[2]) 
...
local NumLoop = tonumber(MsgText[2])
redis:set(jack..':Timer_Cleaner:'..msg.chat_id_,NumLoop) 
...
local Admins = redis:scard(jack..':FASSTAS_Group:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد منشئيين اساسييين ليتم مسحهم ✓" 
end
redis:del(jack..':FASSTAS_Group:'..msg.chat_id_)
...
local Admins = redis:scard(jack..'admins:'..msg.chat_id_)
if Admins == 0 then  
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ادمنيه ليتم مسحهم ✓" 
end
redis:del(jack..'admins:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦ تم مسح {"..Admins.."} من الادمنيه في البوت \n✓"
end
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local Mn3Word = redis:scard(jack..':Filter_Word:'..msg.chat_id_)
if Mn3Word == 0 then 
return "📡*¦* عذرا لا توجد كلمات ممنوعه ليتم حذفها ✓" 
end
redis:del(jack..':Filter_Word:'..msg.chat_id_)
...
redis:del(jack..'rulse:msg'..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(jack..'welcome:msg'..msg.chat_id_) then 
return "📡*¦* اوه ☢ هنالك خطأ 🚸\n📛¦ عذرا لا يوجد ترحيب ليتم مسحه ✓" 
end
redis:del(jack..'welcome:msg'..msg.chat_id_)
...
local NumMnsha = redis:scard(jack..':FASSTAS_BOT:'..msg.chat_id_)
if NumMnsha ==0 then 
return "📛¦ عذرا لا يوجد منشئيين ليتم مسحهم \n!" 
end
redis:del(jack..':FASSTAS_BOT:'..msg.chat_id_)
...
if not msg.Creator then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local NumMDER = redis:scard(jack..'owners:'..msg.chat_id_)
if NumMDER ==0 then 
return "📛¦ عذرا لا يوجد مدراء ليتم مسحهم \n!" 
end
redis:del(jack..'owners:'..msg.chat_id_)
...
local list = redis:smembers(jack..'banned:'..msg.chat_id_)
if #list == 0 then return "*📌¦ لا يوجد مستخدمين محظورين  *" end
message = '📋*¦* قائمه الاعضاء المحظورين :\n'
for k,v in pairs(list) do
StatusLeft(msg.chat_id_,v)
end 
redis:del(jack..'banned:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..#list.." *} من المحظورين  \n✓"
end

if MsgText[2] == 'المكتومين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MKTOMEN = redis:scard(jack..'is_silent_users:'..msg.chat_id_)
if MKTOMEN ==0 then 
return "📡*¦* لا يوجد مستخدمين مكتومين في المجموعه " 
end
redis:del(jack..'is_silent_users:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MKTOMEN.." *} من المكتومين  \n✓"
end

if MsgText[2] == 'المميزين' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local MMEZEN = redis:scard(jack..'whitelist:'..msg.chat_id_)
if MMEZEN ==0 then 
return "*⚙️*¦ لا يوجد مستخدمين مميزين في المجموعه " 
end
redis:del(jack..'whitelist:'..msg.chat_id_)
return "📮¦ بواسطه ⋙ "..msg.TheRankCmd.."   \n📛¦  تم مسح {* "..MMEZEN.." *} من المميزين  \n✓"
end

if MsgText[2] == 'الرابط' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if not redis:get(jack..'linkGroup'..msg.chat_id_) then 
return "*⚙️*¦ لا يوجد رابط مضاف اصلا " 
end
redis:del(jack..'linkGroup'..msg.chat_id_)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jack..'name:witting'..msg.sender_user_id_,300,true)
...
redis:setex(jack..'photo:group'..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jack..'about:witting'..msg.sender_user_id_,300,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الوصف  للمجموعه\n🛠" 
end

if MsgText[1] == "تاك للكل" then 
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if not redis:get(jack.."lock_takkl"..msg.chat_id_) then  return "📛*¦* الامر معطل من قبل الادراة" end 
return TagAll(msg) 
end
...
if redis:sismember(jack..':Filter_Word:'..arg.ChatID,Type_id) then 
return sendMsg(arg.ChatID,arg.MsgID,"📝*¦* هي بالتأكيد في قائمه المنع✓️")
else
redis:sadd(jack..':Filter_Word:'..arg.ChatID,Type_id) 
...
if redis:sismember(jack..':Filter_Word:'..arg.ChatID,Type_id) then 
redis:srem(jack..':Filter_Word:'..arg.ChatID,Type_id) 
...
kick_user(v.user_id_,arg.ChatID,function(arg,data)  
redis:srem(jack..':FASSTAS_BOT:'..arg.ChatID,v.user_id_)
redis:srem(jack..'whitelist:'..arg.ChatID,v.user_id_)
redis:srem(jack..'owners:'..arg.ChatID,v.user_id_)
redis:srem(jack..'admins:'..arg.ChatID,v.user_id_)
end)
end
NumMem = NumMem + 1
...
redis:setex(jack..'ExpireDate:'..msg.chat_id_, extime, true)
if not redis:get(jack..'CheckExpire::'..msg.chat_id_) then 
redis:set(jack..'CheckExpire::'..msg.chat_id_,true) end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم شحن الاشتراك الى `'..MsgText[2]..'` يوم   ... 👍🏿\n🕵🏼️‍♀️¦ في مجموعه  » »  '..redis:get(jack..'group:name'..msg.chat_id_))
else
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if MsgText[2] == '1' then
redis:setex(jack..'ExpireDate:'..msg.chat_id_, 2592000, true)
if not redis:get(jack..'CheckExpire::'..msg.chat_id_) then 
redis:set(jack..'CheckExpire::'..msg.chat_id_,true) 
end
sendMsg(msg.chat_id_,msg.id_,'💂🏻‍♀️¦ تم تفعيل الاشتراك   👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
sendMsg(SUDO_ID,0,'💂🏻‍♀️¦ تم تفعيل الاشتراك  👍🏿\n📆¦  الاشتراك » `30 يوم`  *(شهر)*')
end
if MsgText[2] == '2' then
redis:setex(jack..'ExpireDate:'..msg.chat_id_,7776000,true)
if not redis:get(jack..'CheckExpire::'..msg.chat_id_) then 
redis:set(jack..'CheckExpire::'..msg.chat_id_,true) 
end
...
if MsgText[2] == '3' then
redis:set(jack..'ExpireDate:'..msg.chat_id_,true)
if not redis:get(jack..'CheckExpire::'..msg.chat_id_) then 
redis:set(jack..'CheckExpire::'..msg.chat_id_,true) end
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
local check_time = redis:ttl(jack..'ExpireDate:'..msg.chat_id_)
...
Getrtb = 'مطور اساسي ' 
elseif redis:sismember(jack..':SUDO_BOT:',arg.UserID) then
Getrtb = 'مطور ' 
elseif redis:sismember(jack..':FASSTAS_Group:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشى اساسي' 
elseif redis:sismember(jack..':FASSTAS_BOT:'..arg.ChatID,arg.UserID) then
Getrtb = 'منشئ' 
elseif redis:sismember(jack..'owners:'..arg.ChatID,arg.UserID) then
Getrtb = 'المدير ' 
elseif redis:sismember(jack..'admins:'..arg.ChatID,arg.UserID) then
Getrtb = 'ادمن' 
elseif redis:sismember(jack..'whitelist:'..arg.ChatID,arg.UserID) then
Getrtb = 'مميز' 
else
Getrtb = 'عضو' 
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:get(jack..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:get(jack..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:get(jack..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:get(jack..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:get(jack..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:get(jack..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:get(jack..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:get(jack..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:get(jack..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
return '🧟‍♂*¦*  عدد جهہآتگ آلمـضـآفهہ‏‏ » 【'..(redis:get(jack..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..'】 . \n🐾'
end
...
SUDO_USER = redis:hgetall(jack..'username:'..SUDO_ID).username
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:set(jack..'welcom:witting'..msg.sender_user_id_,true) 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
if redis:get(jack..'welcome:msg'..msg.chat_id_)  then
return Flter_Markdown(redis:get(jack..'welcome:msg'..msg.chat_id_))
else 
...
ReUsername = ResolveUserName(data)
NameUser = Hyper_Link_Name(data)
if redis:sismember(jack..':FASSTAS_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ اساسي  في المجموعه \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ اساسي  في المجموعه \n✓") 
redis:hset(jack..'username:'..arg.UserID,'username',ReUsername)
redis:sadd(jack..':FASSTAS_Group:'..arg.ChatID,arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if redis:sismember(jack..':FASSTAS_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته منشئ اساسي  في المجموعه \n✓") 
else
redis:hset(jack..'username:'..UserID,'username',arg.UserName)
redis:sadd(jack..':FASSTAS_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته منشئ اساسي  في المجموعه \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not redis:sismember(jack..':FASSTAS_Group:'..arg.ChatID,arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه \n✓") 
redis:srem(jack..':FASSTAS_Group:'..arg.ChatID,arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
UserName = Flter_Markdown(arg.UserName)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jack..':FASSTAS_Group:'..arg.ChatID,UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله منشئ اساسي  في المجموعه \n✓") 
else
redis:srem(jack..':FASSTAS_Group:'..arg.ChatID,UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله منشئ اساسي  في المجموعه \n✓")
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
redis:del(jack..":awamer_Klesha_m1:")
redis:del(jack..":awamer_Klesha_m2:")
redis:del(jack..":awamer_Klesha_m3:")
redis:del(jack..":awamer_Klesha_mtwr:")
redis:del(jack..":awamer_Klesha_mrd:")
redis:del(jack..":awamer_Klesha_mf:")
redis:del(jack..":awamer_Klesha_m:")
...
redis:del(jack..":infoiduser_public:"..msg.chat_id_)
...
if not msg.Creator then return "📛*¦* هذا الامر يخص {منشئ اساسي,المنشئ,المطور} فقط  \n🚶" end
redis:setex(jack..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
elseif redis:sismember(jack..'admins:'..msg.chat_id_,UserID) then 
rinkuser = 6
elseif redis:sismember(jack..'whitelist:'..msg.chat_id_,UserID) then 
rinkuser = 7
else
rinkuser = 8
end
local DonisDown = "\n📛¦ تم تنزيله من الرتب الاتيه : \n\n "
if redis:sismember(jack..':SUDO_BOT:',UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المطور ✓️\n"
end 
if redis:sismember(jack..':FASSTAS_Group:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ الاساسي ✓️\n"
end 
if redis:sismember(jack..':FASSTAS_BOT:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المنشئ ✓️\n"
end 
if redis:sismember(jack..'owners:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من المدير ✓️\n"
end 
if redis:sismember(jack..'admins:'..msg.chat_id_,UserID) then 
DonisDown = DonisDown.."❌¦ تم تنزيله من الادمن ✓️\n"
end 
if redis:sismember(jack..'whitelist:'..msg.chat_id_,UserID) then
...
redis:srem(jack..':SUDO_BOT:',UserID)
redis:srem(jack..':FASSTAS_Group:'..msg.chat_id_,UserID)
redis:srem(jack..':FASSTAS_BOT:'..msg.chat_id_,UserID)
redis:srem(jack..'owners:'..msg.chat_id_,UserID)
redis:srem(jack..'admins:'..msg.chat_id_,UserID)
redis:srem(jack..'whitelist:'..msg.chat_id_,UserID)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local list = redis:hgetall(jack..":AwamerBotArray2:"..msg.chat_id_)
local list2 = redis:hgetall(jack..":AwamerBotArray:"..msg.chat_id_)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local Awammer 	= redis:del(jack..":AwamerBot:"..msg.chat_id_)
redis:del(jack..":AwamerBotArray:"..msg.chat_id_)
redis:del(jack..":AwamerBotArray2:"..msg.chat_id_)
if Awammer ~= 0 then
...
for k, BD in pairs(XBD) do if MsgText[2]:match(BD) then  checkAmr = true end end      
if checkAmr then
redis:setex(jack..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,300,MsgText[2])
return "📭¦ حسننا عزيزي , لتغير امر {* "..MsgText[2].." *}  ارسل الامر الجديد الان \n..."
else
return "📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n🚶"
end
else
redis:setex(jack..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
if MsgText[2] then
local checkk = redis:hdel(jack..":AwamerBotArray2:"..msg.chat_id_,MsgText[2])
local AmrOld = redis:hgetall(jack..":AwamerBotArray:"..msg.chat_id_)
amrnew = ""
amrold = ""
...
redis:hdel(jack..":AwamerBotArray:"..msg.chat_id_,Amor)
...
redis:setex(jack..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(jack..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,300,true)
...
redis:setex(jack..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,1000,true)
...
NameUser = Hyper_Link_Name(data)
if redis:sismember(jack..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد ترقيته مطور  في البوت \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مطور  في البوت \n✓") 
redis:hset(jack..'username:'..arg.UserID,'username',RUSERNAME)
redis:sadd(jack..':SUDO_BOT:',arg.UserID)
end
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
redis:hset(jack..'username:'..UserID,'username',ReUsername)
redis:sadd(jack..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم ترقيته مطور  في البوت \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
GetUserID(UserID,function(arg,data)
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jack..':SUDO_BOT:',arg.UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت \n✓") 
else
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت \n✓") 
redis:srem(jack..':SUDO_BOT:',arg.UserID)
end  
end,{ChatID=arg.ChatID,UserID=UserID,MsgID=arg.MsgID})
end,{ChatID=msg.chat_id_,MsgID=msg.id_})
end
...
local UserID = data.id_
NameUser = Hyper_Link_Name(data)
if not redis:sismember(jack..':SUDO_BOT:',UserID) then 
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم بالتأكيد تنزيله مطور  في البوت \n✓") 
else
redis:srem(jack..':SUDO_BOT:',UserID)
sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n📋¦ تم تنزيله مطور  في البوت \n✓") 
...
local pv = redis:smembers(jack..'users')
local NumPvDel = 0
for i = 1, #pv do
...
redis:setex(jack..'welcom_ph:witting'..msg.sender_user_id_,300,true) 
...
local Photo_Weloame = redis:get(jack..':WELCOME_BOT')
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[💯¦ مـرحبآ آنآ بوت آسـمـي ]]..redis:get(jack..':NameBot:')..[[ 🎖
...
redis:setex(jack..'text_sudo:witting'..msg.sender_user_id_,1200,true) 
return '📭¦ حسننا عزيزي 🍁\n📋¦ الان قم بارسال الكليشه \n🛠' 
end

if MsgText[1] == "ضع شرط التفعيل" and MsgText[2] and MsgText[2]:match('^%d+$') then 
redis:set(jack..':addnumberusers',MsgText[2]) 
return '💱*¦* تم وضـع شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..MsgText[2]..'】* عضـو  🍁\n' 
end

if MsgText[1] == "شرط التفعيل" then 
return'🚸*¦* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(jack..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🔝" then 
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
return '📮*¦* عدد المجموعات المفعلة » `'..redis:scard(jack..'group:ids')..'`  ➼' 
end
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(jack.."lockidedit") then return "📛*¦* الامر معطل من قبل المطور الاساسي  \n🚶" end
redis:del(jack..":infoiduser")
...
if not msg.SudoUser then return "📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(jack.."lockidedit") then return "📛*¦* تعيين الايدي معطل من قبل المطور الاساسي  \n🚶" end
redis:setex(jack..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,1000,true)
return '📮*¦* حسننا , الان ارسل كليشه الايدي الجديده \n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n قناه تعليمات ونشر كلايش الايدي \n قناه الكلايش : [@Change_id] \n➼' 
end
...
return redis:get(jack..":TEXT_SUDO") or '🗃¦ لا توجد كليشه المطور .\n📰¦ يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n📡'
end

if MsgText[1] == "اذاعه بالتثبيت"  or MsgText[1] =="اذاعه بالتثبيت 📬" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(jack..'lock_brod') then return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" end
redis:setex(jack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,300, true) 
return "📭¦ حسننا الان ارسل رساله ليتم اذاعتها بالتثبيت  \n🔛" 
end

if MsgText[1] == "اذاعه عام بالتوجيه" or MsgText[1] == "اذاعه عام بالتوجيه 📣" then
if not msg.SudoUser then return"📛*¦* هذا الامر يخص {المطور} فقط  \n🚶" end
if not msg.SudoBase and not redis:get(jack..'lock_brod') then 
return "📡*¦* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(jack..'fwd:'..msg.sender_user_id_,300, true) 
...
redis:setex(jack..'fwd:all'..msg.sender_user_id_,300, true) 
...
redis:setex(jack..'fwd:pv'..msg.sender_user_id_,300, true) 
...
redis:setex(jack..'fwd:groups'..msg.sender_user_id_,300, true) 
...
redis:hset(jack..'username:'..arg.UserID,'username',USERNAME)
redis:sadd(jack..'gban_users',arg.UserID)
...
if redis:sismember(jack..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد حظره عام  من المجموعات \n✓") 
else
redis:hset(jack..'username:'..UserID,'username',UserName)
redis:sadd(jack..'gban_users',UserID)
...
if GeneralBanned(arg.UserID) then 
redis:srem(jack..'gban_users',arg.UserID)
...
if not redis:sismember(jack..'gban_users',UserID) then 
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم بالتأكيد الغاء حظره العام  من المجموعات \n✓") 
else
redis:srem(jack..'gban_users',UserID)
return sendMsg(arg.ChatID,arg.MsgID,"📮¦ المستخدم  ⋙「 "..NameUser.." 」 \n⛔️¦ تم الغاء حظره العام  من المجموعات \n✓") 
end
end,{ChatID=msg.chat_id_,MsgID=msg.id_,UserName=MsgText[2]})
end 
...
if not msg.Admin then return "📛*¦* هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n🚶" end
redis:del(jack..'welcom:witting'..msg.sender_user_id_,
jack..'rulse:witting'..msg.sender_user_id_,
jack..'rulse:witting'..msg.sender_user_id_,
jack..'name:witting'..msg.sender_user_id_,
jack..'about:witting'..msg.sender_user_id_,
jack..'fwd:all'..msg.sender_user_id_,
jack..'fwd:pv'..msg.sender_user_id_,
jack..'fwd:groups'..msg.sender_user_id_,
jack..'namebot:witting'..msg.sender_user_id_,
jack..'addrd_all:'..msg.sender_user_id_,
jack..'delrd:'..msg.sender_user_id_,
jack..'addrd:'..msg.sender_user_id_,
jack..'delrdall:'..msg.sender_user_id_,
jack..'text_sudo:witting'..msg.sender_user_id_,
jack..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_,
jack..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_,
jack..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_,
jack..'addrd:'..msg.chat_id_..msg.sender_user_id_,
jack..':KStart:'..msg.chat_id_..msg.sender_user_id_,
jack.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_,
jack..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_,
jack..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_,
jack..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_,
jack..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_,
jack..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_,
jack..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,
jack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_,
jack..":ForceSub:"..msg.sender_user_id_,
jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
return '👨🏾‍🔧¦ اصدار سورس الحلم الاسود : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس ™') then
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://raw.githubusercontent.com/jack1eljoker1/BDFiles/master/GetVersion.txt') or "0"
GetVerison = GetVerison:gsub("\n",""):gsub(" ","")
if GetVerison > version then
UpdateSourceStart = true
sendMsg(msg.chat_id_,msg.id_,'🔛*¦* يوجد تحديث جديد الان \n📡*¦* جاري تنزيل وتثبيت التحديث  ...')
redis:set(jack..":VERSION",GetVerison)
return false
else
...
sendMsg(arg.chat_id_,arg.id_,'📛*¦* عذرا اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس الحلم الاسود يرجى جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n❕')
end  
else
...
local inline = {{{text="قنآهہ‏‏ آلسـورس : الحلم الاسود 🍃",url="t.me/BLACK_OF_DREEM"}}}
send_key(msg.sender_user_id_,'  [قناة السورس : الحلم الاسود](t.me/BLACK_OF_DREEM)',nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 📈" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
return 'الاحصائيات : 📈 \n\n👥*¦* عدد المجموعات المفعله : '..redis:scard(jack..'group:ids')..'\n👤*¦* عدد المشتركين في البوت : '..redis:scard(jack..'users')..'\n📡'
end
---------------[End Function data] -----------------------
if MsgText[1]=="اضف رد عام" or MsgText[1]=="اضف رد عام ➕" then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_,300,true)
redis:del(jack..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(jack..':KStart:'..msg.chat_id_..msg.sender_user_id_,900,true)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:del(jack..':Text_Start')
return "📭¦ تم مسح كليشه الستارت "
end

if MsgText[1]== 'مسح' and MsgText[2]== 'الردود' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names 	= redis:exists(jack..'replay:'..msg.chat_id_)
local photo 	= redis:exists(jack..'replay_photo:group:'..msg.chat_id_)
local voice 	= redis:exists(jack..'replay_voice:group:'..msg.chat_id_)
local imation   = redis:exists(jack..'replay_animation:group:'..msg.chat_id_)
local audio	 	= redis:exists(jack..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:exists(jack..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:exists(jack..'replay_video:group:'..msg.chat_id_)
if names or photo or voice or imation or audio or sticker or video then
redis:del(jack..'replay:'..msg.chat_id_,jack..'replay_photo:group:'..msg.chat_id_,jack..'replay_voice:group:'..msg.chat_id_,
jack..'replay_animation:group:'..msg.chat_id_,jack..'replay_audio:group:'..msg.chat_id_,jack..'replay_sticker:group:'..msg.chat_id_,jack..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:exists(jack..'replay:all')
local photo 	= redis:exists(jack..'replay_photo:group:')
local voice 	= redis:exists(jack..'replay_voice:group:')
local imation 	= redis:exists(jack..'replay_animation:group:')
local audio 	= redis:exists(jack..'replay_audio:group:')
local sticker 	= redis:exists(jack..'replay_sticker:group:')
local video 	= redis:exists(jack..'replay_video:group:')
if names or photo or voice or imation or audio or sticker or video then
redis:del(jack..'replay:all',jack..'replay_photo:group:',jack..'replay_voice:group:',jack..'replay_animation:group:',jack..'replay_audio:group:',jack..'replay_sticker:group:',jack..'replay_video:group:')
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:set(jack..'delrdall:'..msg.sender_user_id_,true) 
return "📭¦ حسننا عزيزي  ✋🏿\n🗯¦ الان ارسل الرد لمسحها من  المجموعات 🍃"
end

if MsgText[1]== 'مسح' and MsgText[2]== 'رد' then
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:set(jack..'delrd:'..msg.sender_user_id_,true)
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
local names  	= redis:hkeys(jack..'replay:'..msg.chat_id_)
local photo 	= redis:hkeys(jack..'replay_photo:group:'..msg.chat_id_)
local voice  	= redis:hkeys(jack..'replay_voice:group:'..msg.chat_id_)
local imation 	= redis:hkeys(jack..'replay_animation:group:'..msg.chat_id_)
local audio 	= redis:hkeys(jack..'replay_audio:group:'..msg.chat_id_)
local sticker 	= redis:hkeys(jack..'replay_sticker:group:'..msg.chat_id_)
local video 	= redis:hkeys(jack..'replay_video:group:'..msg.chat_id_)
...
local names 	= redis:hkeys(jack..'replay:all')
local photo 	= redis:hkeys(jack..'replay_photo:group:')
local voice 	= redis:hkeys(jack..'replay_voice:group:')
local imation 	= redis:hkeys(jack..'replay_animation:group:')
local audio 	= redis:hkeys(jack..'replay_audio:group:')
local sticker 	= redis:hkeys(jack..'replay_sticker:group:')
local video 	= redis:hkeys(jack..'replay_video:group:')
if #names==0 and #photo==0 and #voice==0 and #imation==0 and #audio==0 and #sticker==0 and #video==0 then 
return '🚸*¦* لا يوجد ردود مضافه حاليا \n❕' 
end
local ii = 1
...
if not msg.Director then return "📛*¦* هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n🚶" end
redis:setex(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_,300,true) 
redis:del(jack..'replay1'..msg.chat_id_..msg.sender_user_id_)
return "📭¦ حسننا , الان ارسل كلمه الرد \n-"
end

if MsgText[1] == "ضع اسم للبوت" or MsgText[1]== 'ضع اسم للبوت ©' then
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
redis:setex(jack..'namebot:witting'..msg.sender_user_id_,300,true)
...
if msg.SudoBase and (MsgText[1]=="م1" or MsgText[1]=="م2" or MsgText[1]=="م3" or MsgText[1]=="م المطور" or MsgText[1]=="اوامر الرد" or MsgText[1]=="الاوامر" or MsgText[1]=="اوامر الملفات") and redis:get(jack..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(jack..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_)
redis:setex(jack..":changawmer:"..msg.chat_id_..msg.sender_user_id_,900,MsgText[1])
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_m:")
if textD then
...
👨‍💻¦ رفع منشى اساسي ‿ تنزيل منشى اساسي
👮‍♂️¦ رفع مشرف ‿ تنزيل مشرف 
🔮¦ رفع منشى ‿ تنزيل منشى 
⚗¦ رفع المدير ‿ تنزيل المدير
📿¦ رفع ادمن ‿ تنزيل ادمن 
💈¦ رفع مميز ‿ تنزيل مميز 
👤¦ تنزيل الكل ‿  لأزاله جميع الرتب أعلاه

⦅ ꯭آو꯭آم꯭ـر آ꯭لم꯭ـس꯭ـح꯭ للم꯭ـنش꯭ـى꯭ ⦆

🗑¦ مسح المنشئين الاساسيين •⊱ لمسح المشئين الاساسيين
🗑¦ مسح المنشئين •⊱ لمسح المنشئين
🗑¦ مسح المدراء •⊱ لمسح المدراه
🗑¦ مسح الادمنيه •⊱ لمسح الادمنيه
🗑¦ مسح المميزين •⊱ لمسح المميزين
🗑¦ مسح المحظورين •⊱ لمسح المحظورين
🗑¦ مسح المكتومين •⊱ لمسح المكتومين
🗑¦ مسح قائمه العام •⊱ لمسح المحظورين عام
🗑¦ مسح قائمه المنع •⊱ لمسح قائمه المنع
🗑¦ مسح الردود العامه •⊱ لمسح الردود العامه
🗑¦ مسح الردود •⊱ لمسح الردود
🗑¦ مسح الاوامر •⊱ لمسح الاوامر
🗑¦ مسح + عدد •⊱ لمسح عدد من الرسائل
🗑¦ مسح بالرد •⊱ لمسح الرسالة بالرد
🗑¦ مسح ايدي عام •⊱ لمسح كليشه الايدي العام
🗑¦ مسح كليشه الايدي •⊱ لمسح كليشه الايدي
🗑¦ مسح كليشه الستارت •⊱ لمسح كليشه الستارت
🗑¦ مسح الترحيب •⊱ لمسح الترحيب
🗑¦ مسح الرابط •⊱ لمسح الرابط
🗑¦ مسح كلايش التعليمات •⊱ لمسح التعليمات

⦅آوآمـر آلحظـر وآلطــرد وآلتقييـد  ⦆
      
🔱¦ حظر (بالرد/بالمعرف/بالايدي) •⊱ لحظر العضو
⚜¦ طرد ( بالرد/بالمعرف/بالايدي) •⊱ لطرد العضو 
🔅¦ كتم (بالرد/بالمعرف/بالايدي) •⊱ لكتم العضو 
🌀¦ تقييد (بالرد/بالمعرف/بالايدي) •⊱ لتقييد العضو
🚫¦ منع + الكلمه •⊱ لمنع كلمه داخل المجموعه
🚸¦ الغاء الحظر (بالرد/بالمعرف/بالايدي) •⊱ لالغاء الحظر 
🔆¦ الغاء الكتم (بالرد/بالمعرف/بالايدي) •⊱ لالغاء الكتم 
〰¦ فك التقييد (بالرد/بالمعرف/بالايدي) •⊱ لالغاء تقييد العضو 
☑¦ رفع القيود (بالرد/بالمعرف/بالايدي) •⊱ لالغاء قيود (كتم/حظر/حظر عام/تقييد)
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_m1:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
💭¦ اضف امر :↜  لاضافه امر  
💭¦ اضف رد عام :↜  لاضافه رد عام  
💭¦ تعيين ايدي عام :↜  لتعيين كليشه الايدي عام  
💭¦ تعيين كليشه الايدي :↜  لتعيين كليشه الايدي  
📮¦ـ➖➖➖➖➖

👨🏽‍💻¦ اوامر رؤية الاعدادات ::

🗯¦ المطورين :↜ لعرض  المطورين 
🗯¦ المنشئين الاساسيين :↜ لعرض  المنشئين الاساسيين 
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_m2:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_m3:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
🔅¦ مسح المطورين : لمسح كل المطورين
 🔅¦ مسح المنشئين : لمسح المنشئين
 🔅¦ مسح المنشئين الاساسيين : لمسح المنشئين الاساسيين
 
🔅¦ مسح كلايش التعليمات : لمسح كلايش التعليمات
🔅¦ تعيين قائمه الاوامر : لتعيين قائمه الاوامر
🔅¦ مسح كلايش التعليمات : لمسح كلايش التعليمات
🔅¦ تعيين كليشه الستارت : لتعيين كليشه الستارت
🔅¦ تعيين ايدي عام : لتعيين ايدي عام
🔅¦ مسح ايدي عام : لمسح ايدي عام
...
🔅¦ اذاعه بالتثبيت : لنشر رساله لكل المجموعات مع تثبيتها
🔅¦ اذاعه عام بالتوجيه : لنشر منشور قناتك بالتوجيه للكل
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_mtwr:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_mrd:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
GetUserID(msg.sender_user_id_,function(arg,data)
msg = arg.msg
local textD = redis:get(jack..":awamer_Klesha_mf:")
if textD then
textD = Flter_Markdown(convert_Klmat(msg,data,textD,true))
else
textD = text
...
if not redis:get(jack.."lock_leftgroup"..msg.chat_id_) then  return "📛*¦* امر المغادره معطل من قبل اداره المجموعة  \n🚶" end
kick_user(msg.sender_user_id_,msg.chat_id_,function(arg,data)
if data.ID == "Ok" then
StatusLeft(msg.chat_id_,msg.sender_user_id_)
send_msg(msg.sender_user_id_,"👨🏼‍⚕️¦ اهلا عزيزي , لقد تم طردك من المجموعه بامر منك \n🔖¦ اذا كان هذا بالخطأ او اردت الرجوع للمجموعه \n\n🔖¦فهذا رابط المجموعه 💯\n🌿¦"..Flter_Markdown(redis:get(jack..'group:name'..msg.chat_id_)).." :\n\n["..redis:get(jack..'linkGroup'..msg.chat_id_).."]\n")
...
return [[
🛠 ┇ تنصـيب سـورس الحلم الاسود 🔎

 ⇓⇓⇓ 

`git clone https://github.com/jack1eljoker1/BD.git ;cd BD;chmod +x ins;./ins
`
...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local Get_Files, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/BDFiles/master/GetFiles.json")
print(Get_Files)
print(res)
if res == 200 then
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/jack1eljoker1/BDFiles/master/plugins/"..FileName)
if res == 200 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
if redis:get(jack..":UserNameChaneel") then
return "📑¦ اهلا عزيزي المطور \n🔖¦ الاشتراك بالتأكيد مفعل"
else
redis:setex(jack..":ForceSub:"..msg.sender_user_id_,350,true)
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local SubDel = redis:del(jack..":UserNameChaneel")
if SubDel == 1 then
...
if not msg.SudoBase then return"📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local UserChaneel = redis:get(jack..":UserNameChaneel")
if UserChaneel then
...
local function dBD(msg)

if msg.type == "pv" then 

if not msg.SudoUser then
local msg_pv = tonumber(redis:get(jack..'user:'..msg.sender_user_id_..':msgs') or 0)
if msg_pv > 5 then
redis:setex(jack..':mute_pv:'..msg.sender_user_id_,18000,true)   
return sendMsg(msg.chat_id_,0,'*📛¦* تم حظرك من البوت بسبب التكرار \n🛠') 
end
redis:setex(jack..'user:'..msg.sender_user_id_..':msgs',2,msg_pv+1)
end
...
redis:sadd(jack..'users',msg.sender_user_id_)
SUDO_USER = redis:hgetall(jack..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
SUDO_USERR = "⚖️¦ مـعرف آلمـطـور  : "..SUDO_USER
else
...
text = [[💯¦ مـرحبآ آنآ بوت آسـمـي []]..redis:get(jack..':NameBot:')..[[] 🎖
💰¦ آختصـآصـي حمـآيهہ‏‏ آلمـجمـوعآت
📛¦ مـن آلسـبآم وآلتوجيهہ‏‏ وآلتگرآر وآلخ...
...
GetUserID(msg.sender_user_id_,function(arg,data)
if data.last_name_ then Name = data.first_name_ .." "..data.last_name_ else Name = data.first_name_ end
text = redis:get(jack..':Text_Start') or text
local edited = (redis:get(jack..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local points = redis:get(jack..':User_Points:'..msg.chat_id_..msg.sender_user_id_) or 0
local Emsgs = redis:get(jack..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 1
if data.username_ then UserNameID = "@"..data.username_ else UserNameID = "لا يوجد" end  
...
text = text:gsub("{البوت}",redis:get(jack..':NameBot:'))
...
local MSG_ID = (redis:get(jack.."USER_MSG_TWASEL"..data.forward_info_.date_) or 1)
msg = arg.msg
local SendOk = false
...
if not redis:get(jack..'lock_twasel') then
...
redis:setex(jack.."USER_MSG_TWASEL"..msg.date_,43200,msg.id_)
...
--====================== Reply Only Group =====================================
if redis:get(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_) and redis:get(jack..'replay1'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(jack..'replay1'..msg.chat_id_..msg.sender_user_id_)
if msg.content_ and msg.content_.caption_ then redis:hset(jack..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then 
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
redis:hset(jack..'replay:'..msg.chat_id_,klma,msg.text)
...
redis:hset(jack..'replay_photo:group:'..msg.chat_id_,klma,photo_id)
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(jack..'replay_voice:group:'..msg.chat_id_,klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(jack..'replay_animation:group:'..msg.chat_id_,klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(jack..'replay_video:group:'..msg.chat_id_,klma,msg.content_.video_.video_.persistent_id_)
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(jack..'replay_audio:group:'..msg.chat_id_,klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد بنجاح ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(jack..'replay_sticker:group:'..msg.chat_id_,klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_)
...
--====================== Reply All Groups =====================================
if redis:get(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) and redis:get(jack..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then
local klma = redis:get(jack..'allreplay:'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.caption_ then redis:hset(jack..':caption_replay:'..msg.chat_id_,klma,msg.content_.caption_) end
if msg.text then
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
if utf8.len(msg.text) > 4000 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه جواب الرد باكثر من 4000 حرف تم الغاء الامر\n❕")
end
redis:hset(jack..'replay:all',klma,msg.text)
...
redis:hset(jack..'replay_photo:group:',klma,photo_id)
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه صوره للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVoice" then
redis:hset(jack..'replay_voice:group:',klma,msg.content_.voice_.voice_.persistent_id_)
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه بصمه صوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لسماع البصمه الاتيه .')
elseif msg.content_.ID == "MessageAnimation" then
redis:hset(jack..'replay_animation:group:',klma,msg.content_.animation_.animation_.persistent_id_)
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه متحركه للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوره الاتيه .')
elseif msg.content_.ID == "MessageVideo" then
redis:hset(jack..'replay_video:group:',klma,msg.content_.video_.video_.persistent_id_)
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه فيديو للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الفيديو الاتي .')
elseif msg.content_.ID == "MessageAudio" then
redis:hset(jack..'replay_audio:group:',klma,msg.content_.audio_.audio_.persistent_id_)
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂¦ تم اضافه للصوت للرد العام ✓\n🗂¦ يمكنك ارسال (['..klma..']) لاضهار الصوت الاتي .')
elseif msg.content_.ID == "MessageSticker" then
redis:hset(jack..'replay_sticker:group:',klma,msg.content_.sticker_.sticker_.persistent_id_)
redis:del(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
if msg.Director and (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(jack.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(jack.."WiCmdLink"..msg.chat_id_..msg.sender_user_id_)
redis:set(jack..'linkGroup'..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين الرابط بنجاح  ")
return false
end

if msg.Creator and redis:get(jack..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(jack..":Witting_KleshaID_public"..msg.chat_id_..msg.sender_user_id_)
redis:set(jack..":infoiduser_public:"..msg.chat_id_,msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end

if msg.SuperCreator and redis:get(jack..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_) then 

NameUser = redis:get(jack..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
UserID = redis:get(jack..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
if not msg.text:match("[1234567]") and not msg.text:match("[*]") and not msg.text:match("[*][*]") then
redis:del(jack..":uploadingsomeon:"..msg.chat_id_..msg.sender_user_id_)
redis:del(jack..":uploadingsomeon2:"..msg.chat_id_..msg.sender_user_id_)
...
redis:sadd(jack..'admins:'..msg.chat_id_,UserID)
local trues = "✓"
local falses = "✖️"
...
if msg.Creator and redis:get(jack..":changawmer:"..msg.chat_id_..msg.sender_user_id_) and not redis:get(jack..":Witting_awamr_witting"..msg.chat_id_..msg.sender_user_id_) then 
...
local amr = redis:get(jack..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
if amr == "م1" then
redis:set(jack..":awamer_Klesha_m1:",msg.text)
elseif amr == "م2" then
redis:set(jack..":awamer_Klesha_m2:",msg.text)
elseif amr == "م3" then
redis:set(jack..":awamer_Klesha_m3:",msg.text)
elseif amr == "م المطور" then
redis:set(jack..":awamer_Klesha_mtwr:",msg.text)
elseif amr == "اوامر الرد" then
redis:set(jack..":awamer_Klesha_mrd:",msg.text)
elseif amr == "اوامر الملفات" then
redis:set(jack..":awamer_Klesha_mf:",msg.text)
elseif amr == "الاوامر" then
redis:set(jack..":awamer_Klesha_m:",msg.text)
end
redis:del(jack..":changawmer:"..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة التعليمات بنجاح \n📮¦ يمكنك تجربة الامر *{"..amr.."}* ")
end


if msg.SudoUser and redis:get(jack..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_) then 
redis:del(jack..":Witting_KleshaID"..msg.chat_id_..msg.sender_user_id_)
redis:set(jack..":infoiduser",msg.text)
sendMsg(msg.chat_id_,msg.id_,"🔖¦ تم تعيين كليشة الايدي بنجاح \n📮¦ يمكنك تجربة الامر الان ")
return false
end
...
if msg.Director and redis:get(jack..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(jack..":AwamerBotArray2:"..msg.chat_id_)
Amr = redis:get(jack..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
local checknewamr = false
for k, BD in pairs(XBD) do 
local cceck,sec = BD:gsub("[(]"..Amr.."[)]","("..msg.text..")")
if sec ~= 0 then
redis:hset(jack..":AwamerBotArray:"..msg.chat_id_,cceck,BD)
redis:hset(jack..":AwamerBotArray2:"..msg.chat_id_,msg.text,Amr)
end
end  
...
redis:hset(jack..":AwamerBot:"..msg.chat_id_,msg.text,Amr)
sendMsg(msg.chat_id_,msg.id_,"📑¦ تم تغيير الامر القديم ["..Amr.."] \n🔖¦ الى الامر الجديد ["..msg.text.."]\n...")
end
redis:del(jack..":Witting_changeamr:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and not redis:get(jack..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) and redis:get(jack..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_) then
local Awammer 	= redis:hgetall(jack..":AwamerBotArray2:"..msg.chat_id_)
local Amr = redis:get(jack..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
...
redis:del(jack..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_)
return false
end

if msg.Director and redis:get(jack..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_) then
local checkAmr = false
for k, BD in pairs(XBD) do if msg.text:match(BD) then checkAmr = true end end      
if checkAmr then
sendMsg(msg.chat_id_,msg.id_,"📭¦ حسننا عزيزي , لتغير امر {* "..msg.text.." *} \n¦ ارسل الامر الجديد الان \n...")
redis:setex(jack..":firstAmrOld:"..msg.chat_id_..msg.sender_user_id_,900,msg.text)
else
sendMsg(msg.chat_id_,msg.id_,"📛*¦* عذرا لا يوجد هذا الامر في البوت لتتمكن من تغييره  \n🚶")
end
redis:del(jack..":Witting_changeamr2:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
if msg.Director and redis:get(jack..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_) then
local checkk = redis:hdel(jack..":AwamerBotArray2:"..msg.chat_id_,msg.text)
...
redis:del(jack..":Witting_AmrDel:"..msg.chat_id_..msg.sender_user_id_)
return false
end
...
local checkk = redis:hdel(jack..":AwamerBot:"..msg.chat_id_,msg.text)
if checkk ~=0 then
tiires =  "📭¦ تم مسح الامر {* "..msg.text.." *} من قائمه الاومر \n..."
else
tiires = "📛*¦* هذا الامر ليس موجود ضمن الاوامر المضافه  \n🚶"
...
if msg.SudoBase and redis:get(jack..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_) then
...
redis:set(jack..":SUDO_ID:",UserID)
local usero = arg.USERNAME:gsub([[\_]],"_")
redis:hset(jack..'username:'..UserID,'username',usero)
...
redis:del(jack..":Witting_MoveBot:"..msg.chat_id_..msg.sender_user_id_)
return false 
end


if redis:get(jack..":ForceSub:"..msg.sender_user_id_) then
redis:del(jack..":ForceSub:"..msg.sender_user_id_)
if msg.text:match("^@[%a%d_]+$") then
...
redis:set(jack..":UserNameChaneel",msg.text)
...
if redis:get(jack..'namebot:witting'..msg.sender_user_id_) then --- استقبال اسم البوت 
redis:del(jack..'namebot:witting'..msg.sender_user_id_)
redis:set(jack..':NameBot:',msg.text)
Start_Bot() 
sendMsg(msg.chat_id_,msg.id_,"📭¦ تم تغير اسم البوت  ✋🏿\n🗯¦ الان اسمه "..Flter_Markdown(msg.text).." \n✓")
return false
end

if redis:get(jack..'addrd_all:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد لكل المجموعات
if not redis:get(jack..'allreplay:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال كلمه الرد لكل المجموعات
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:hdel(jack..'replay_photo:group:',msg.text)
redis:hdel(jack..'replay_voice:group:',msg.text)
redis:hdel(jack..'replay_animation:group:',msg.text)
redis:hdel(jack..'replay_audio:group:',msg.text)
redis:hdel(jack..'replay_sticker:group:',msg.text)
redis:hdel(jack..'replay_video:group:',msg.text)
redis:setex(jack..'allreplay:'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جوا ب الردالعام \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] ✓\n\n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if redis:get(jack..':KStart:'..msg.chat_id_..msg.sender_user_id_) then
redis:del(jack..':KStart:'..msg.chat_id_..msg.sender_user_id_)
redis:set(jack..':Text_Start',msg.text)
...
if redis:get(jack..'delrdall:'..msg.sender_user_id_) then
redis:del(jack..'delrdall:'..msg.sender_user_id_)
local names = redis:hget(jack..'replay:all',msg.text)
local photo =redis:hget(jack..'replay_photo:group:',msg.text)
local voice = redis:hget(jack..'replay_voice:group:',msg.text)
local animation = redis:hget(jack..'replay_animation:group:',msg.text)
local audio = redis:hget(jack..'replay_audio:group:',msg.text)
local sticker = redis:hget(jack..'replay_sticker:group:',msg.text)
local video = redis:hget(jack..'replay_video:group:',msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(jack..'replay:all',msg.text)
redis:hdel(jack..'replay_photo:group:',msg.text)
redis:hdel(jack..'replay_voice:group:',msg.text)
redis:hdel(jack..'replay_audio:group:',msg.text)
redis:hdel(jack..'replay_animation:group:',msg.text)
...
if redis:get(jack..'text_sudo:witting'..msg.sender_user_id_) then -- استقبال كليشه المطور
redis:del(jack..'text_sudo:witting'..msg.sender_user_id_) 
redis:set(jack..':TEXT_SUDO',Flter_Markdown(msg.text))
return sendMsg(msg.chat_id_,msg.id_, "📜*¦* تم وضع الكليشه بنجاح كلاتي 👋🏻\n\n*{*  "..Flter_Markdown(msg.text).."  *}*\n✓")
end
if redis:get(jack..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(jack..'welcom:witting'..msg.sender_user_id_) 
redis:set(jack..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*¦* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(jack..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(jack..'rulse:witting'..msg.sender_user_id_) 
redis:set(jack..'rulse:msg'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'📜*¦* مرحبآ عزيزي\n📦¦ تم حفظ القوانين بنجاح ✓\n🔖¦ ارسل [[ القوانين ]] لعرضها \n🛑✓')
end
if redis:get(jack..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(jack..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(jack..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(jack..'about:witting'..msg.sender_user_id_) 
...
if redis:get(jack..'fwd:all'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه عام
redis:del(jack..'fwd:all'..msg.sender_user_id_)
local pv = redis:smembers(jack..'users')  
local groups = redis:smembers(jack..'group:ids')
...
if redis:get(jack..'fwd:pv'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(jack..'fwd:pv'..msg.sender_user_id_)
local pv = redis:smembers(jack..'users')
if #pv >= 300 then
...
if redis:get(jack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_) then 
redis:del(jack..':prod_pin:'..msg.chat_id_..msg.sender_user_id_)
local groups = redis:smembers(jack..'group:ids')
if #groups >= 300 then
...
if data.chat_id_ then redis:setex(jack..":propin"..data.chat_id_,100,data.content_.text_) end
end)
end
sendMsg(msg.chat_id_,msg.id_,'📑*¦* عدد المجموعات •⊱ { *'..#groups..'*  } ⊰•\n🗣*¦* تـم الاذاعه بالتثبيت بنجاح ✓')
end 

if redis:get(jack..'fwd:groups'..msg.sender_user_id_) then ---- استقبال رساله الاذاعه خاص
redis:del(jack..'fwd:groups'..msg.sender_user_id_)
local groups = redis:smembers(jack..'group:ids')
if #groups >= 300 then
sendMsg(msg.chat_id_,msg.id_,'📑¦ اهلا عزيزي المطور \n🔖¦ جاري نشر الرساله للمجموعات ...')			
end
...
if msg.forward_info_ and redis:get(jack..'fwd:'..msg.sender_user_id_) then
redis:del(jack..'fwd:'..msg.sender_user_id_)
local pv = redis:smembers(jack..'users')
local groups = redis:smembers(jack..'group:ids')
local allgp =  #pv + #groups
if allgp == 500 then
...
if msg.content_.ID == "MessagePhoto" and redis:get(jack..'welcom_ph:witting'..msg.sender_user_id_) then
redis:del(jack..'welcom_ph:witting'..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
end
redis:set(jack..':WELCOME_BOT',photo_id)
return sendMsg(msg.chat_id_,msg.id_,'🚸 ¦ تم تغيير صـورهہ‏‏ آلترحيب للبوت 🌿\n✓')
end 

if msg.content_.ID == "MessagePhoto" and msg.type == "channel" and msg.GroupActive then
if redis:get(jack..'photo:group'..msg.chat_id_..msg.sender_user_id_) then
redis:del(jack..'photo:group'..msg.chat_id_..msg.sender_user_id_)
if msg.content_.photo_.sizes_[3] then 
photo_id = msg.content_.photo_.sizes_[3].photo_.persistent_id_
else 
photo_id = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
if redis:get(jack..'addrd:'..msg.chat_id_..msg.sender_user_id_) then -- استقبال الرد للمجموعه فقط

if not redis:get(jack..'replay1'..msg.chat_id_..msg.sender_user_id_) then  -- كلمه الرد
if utf8.len(msg.text) > 25 then 
return sendMsg(msg.chat_id_,msg.id_,"📛¦ عذرا غير مسموح باضافه كلمه الرد باكثر من 25 حرف \n❕")
end
redis:hdel(jack..'replay:'..msg.chat_id_,msg.text)
redis:hdel(jack..'replay_photo:group:'..msg.chat_id_,msg.text)
redis:hdel(jack..'replay_voice:group:'..msg.chat_id_,msg.text)
redis:hdel(jack..'replay_animation:group:'..msg.chat_id_,msg.text)
redis:hdel(jack..'replay_audio:group:'..msg.chat_id_,msg.text)
redis:hdel(jack..'replay_sticker:group:'..msg.chat_id_,msg.text)
redis:hdel(jack..'replay_video:group:'..msg.chat_id_,msg.text)
redis:setex(jack..'replay1'..msg.chat_id_..msg.sender_user_id_,300,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜¦ جيد , يمكنك الان ارسال جواب الرد \n🔛¦ [[ نص,صوره,فيديو,متحركه,بصمه,اغنيه ]] \n\n علما ان الاختصارات كالاتي : \n \n{الاسم} : لوضع اسم المستخدم\n{الايدي} : لوضع ايدي المستخدم\n{المعرف} : لوضع معرف المستخدم \n{الرتبه} : لوضع نوع رتبه المستخدم \n{التفاعل} : لوضع تفاعل المستخدم \n{الرسائل} : لاضهار عدد الرسائل \n{النقاط} : لاضهار عدد النقاط \n{التعديل} : لاضهار عدد السحكات \n{البوت} : لاضهار اسم البوت\n{المطور} : لاضهار معرف المطور الاساسي\n➼")
end
end

if redis:get(jack..'delrd:'..msg.sender_user_id_) then
redis:del(jack..'delrd:'..msg.sender_user_id_)
local names 	= redis:hget(jack..'replay:'..msg.chat_id_,msg.text)
local photo 	= redis:hget(jack..'replay_photo:group:'..msg.chat_id_,msg.text)
local voice 	= redis:hget(jack..'replay_voice:group:'..msg.chat_id_,msg.text)
local animation = redis:hget(jack..'replay_animation:group:'..msg.chat_id_,msg.text)
local audio 	= redis:hget(jack..'replay_audio:group:'..msg.chat_id_,msg.text)
local sticker 	= redis:hget(jack..'replay_sticker:group:'..msg.chat_id_,msg.text)
local video 	= redis:hget(jack..'replay_video:group:'..msg.chat_id_,msg.text)
if not (names or photo or voice or animation or audio or sticker or video) then
return sendMsg(msg.chat_id_,msg.id_,'🛑*¦* هذا الرد ليس مضاف في قائمه الردود 📛')
else
redis:hdel(jack..'replay:'..msg.chat_id_,msg.text)
...
print(" -- pinned -- ")
local msg_pin_id = redis:get(jack..":MsgIDPin:"..msg.chat_id_)
if not msg.Director and not msg.OurBot and redis:get(jack..'lock_pin'..msg.chat_id_) then
if msg_pin_id then
...
redis:set(jack..":MsgIDPin:"..msg.chat_id_,msg.id_)
end
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(jack..'group:name'..arg.chat_id_,arg.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
if msg.content_.ID == "MessageChatAddMembers" and redis:get(jack..'welcome:get'..msg.chat_id_) then
local adduserx = tonumber(redis:get(jack..'user:'..msg.sender_user_id_..':msgs') or 0)
if adduserx > 3 then 
redis:del(jack..'welcome:get'..msg.chat_id_)
end
redis:setex(jack..'user:'..msg.sender_user_id_..':msgs',3,adduserx+1)
end

if (msg.content_.ID == "MessageChatAddMembers") then
if redis:get(jack..'welcome:get'..msg.chat_id_) then
if msg.adduserType then
welcome = (redis:get(jack..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(jack..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين كلاتي 👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
if msg.addusername then UserName = '@'..msg.addusername else UserName = '< لا يوجد معرف >' end
local edited = (redis:get(jack..':edited:'..msg.chat_id_..':'..msg.adduser) or 0)
local points = redis:get(jack..':User_Points:'..msg.chat_id_..msg.adduser) or 0
local msgs = redis:get(jack..'msgs:'..msg.adduser..':'..msg.chat_id_) or 1

if msg.adduser == SUDO_ID then 
gtupe = 'المطور الاساسي' 
elseif redis:sismember(jack..':SUDO_BOT:',msg.adduser) then 
gtupe = 'المطور'
elseif msg.GroupActive and redis:sismember(jack..':FASSTAS_Group:'..msg.chat_id_,msg.adduser) then 
gtupe = 'منشئ اساسي'
elseif msg.GroupActive and redis:sismember(jack..':FASSTAS_BOT:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المنشىء'
elseif msg.GroupActive and redis:sismember(jack..'owners:'..msg.chat_id_,msg.adduser) then 
gtupe = 'المدير' 
elseif msg.GroupActive and redis:sismember(jack..'admins:'..msg.chat_id_,msg.adduser) then 
gtupe = 'الادمن'
elseif msg.GroupActive and redis:sismember(jack..'whitelist:'..msg.chat_id_,msg.adduser) then 
gtupe = 'عضو مميز'
...
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(jack..'group:name'..msg.chat_id_) or '')))
...
local welcome = welcome:gsub("{البوت}",redis:get(jack..':NameBot:'))
...
GetUserID(msg.sender_user_id_,function(arg,data)
welcome = (redis:get(jack..'welcome:msg'..msg.chat_id_) or "🔖¦ مرحباً عزيزي\n🔖¦ نورت المجموعة \n💂🏼‍♀️")
welcome = welcome:gsub("{القوانين}", redis:get(jack..'rulse:msg'..msg.chat_id_) or "🔖¦ مرحبأ عزيري 👋🏻 القوانين  👇🏻\n🔖¦ ممنوع نشر الروابط \n🔖¦ ممنوع التكلم او نشر صور اباحيه \n🔖¦ ممنوع  اعاده توجيه \n🔖¦ ممنوع التكلم بلطائفه \n🔖¦ الرجاء احترام المدراء والادمنيه 😅\n")
...
if msg.edited and not msg.SuperCreator and redis:get(jack.."antiedit"..msg.chat_id_) then 
...
local monsha = redis:smembers(jack..':FASSTAS_Group:'..msg.chat_id_)
Rwers = ""
...
local info = redis:hgetall(jack..'username:'..v) if info and info.username and info.username:match("@[%a%d_]+") then usersmnc = usersmnc..info.username.." - " end
sendMsg(v,0,"📇¦ هناك شخص قام بالتعديل \n👲🏼¦ الاسم : ⋙「 "..NameUser.." 」 "..uuseri.."\n🀄️¦ الايدي : `"..msg.sender_user_id_.."`\n📬¦ رتبته : "..Getrtba(msg.sender_user_id_,msg.chat_id_).."\n🔌¦ نوع التعديل : "..Rwers.."\n📱¦ المجموعة : "..Flter_Markdown((redis:get(jack..'group:name'..msg.chat_id_) or '')).."\n🔅¦ الرابط : "..redis:get(jack..'linkGroup'..msg.chat_id_).." \n🚸" )
end
end
...
if not msg.Admin and not msg.Special and msg.sender_user_id_ ~= 0 then -- للاعضاء فقط  

if not msg.forward_info_ and msg.content_.ID ~= "MessagePhoto" and redis:get(jack..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(jack..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_MAX = (redis:get(jack..'num_msg_max'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_MAX) then 
redis:setex(jack..'sender:'..msg.sender_user_id_..':'..msg.chat_id_..'flood',30,true)
...
redis:setex(jack..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
end


if msg.forward_info_ then
if redis:get(jack..'mute_forward'..msg.chat_id_) then -- قفل التوجيه
...
if redis:get(jack..'lock_woring'..msg.chat_id_) and not redis:get(jack..':User_Fwd_Msg:'..msg.sender_user_id_..':flood') then
GetUserID(msg.sender_user_id_,function(arg,data)
...
return redis:setex(jack..':User_Fwd_Msg:'..msg.sender_user_id_..':flood',15,true)
end,nil)
end
end)
return false
elseif redis:get(jack..':tqeed_fwd:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and msg.content_.ID ~= "MessageText" and redis:get(jack..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data) 
print("\27[1;31m Msg Del becuse send Edit \27[0m")
if data.ID == "Error" and data.code_ == 6 then
return sendMsg(msg.chat_id_,msg.id_,'📛*¦* لا يمكنني مسح الرساله المخالفه .\n🎟*¦* لست مشرف او ليس لدي صلاحيه  الحذف \n ❕')    
end
if redis:get(jack..'lock_woring'..msg.chat_id_) then
GetUserID(msg.sender_user_id_,function(arg,data)
if data.username_ then USERNAME = '@'..data.username_ else USERNAME = FlterName(data) end
...
return false
elseif tonumber(msg.via_bot_user_id_) ~= 0 and redis:get(jack..'mute_inline'..msg.chat_id_) then -- قفل الانلاين
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if utf8.len(msg.text) > 500 and redis:get(jack..'lock_spam'..msg.chat_id_) then -- قفل الكليشه 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
or msg.text:match("[Ww][Ww][Ww].") 
or msg.text:match(".[Cc][Oo][Mm]")) 
and redis:get(jack..':tqeed_link:'..msg.chat_id_)  then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(jack..'lock_link'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.text:match("[Hh][Tt][Tt][Pp]://") or msg.text:match("[Ww][Ww][Ww].") or msg.text:match(".[Cc][Oo][Mm]") or msg.text:match(".[Tt][Kk]") or msg.text:match(".[Mm][Ll]") or msg.text:match(".[Oo][Rr][Gg]")) and redis:get(jack..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif (msg.text:match("ه‍") or msg.text:match("ی") or msg.text:match("ک")) and redis:get(jack.."lock_pharsi"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif KlmatMmno3(msg.text) and redis:get(jack.."lock_mmno3"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("[a-zA-Z]") and redis:get(jack.."lock_lang"..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("#.+") and redis:get(jack..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.text:match("@[%a%d_]+")  and redis:get(jack..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif not msg.textEntityTypeBold and (msg.textEntityTypeBold or msg.textEntityTypeItalic) and redis:get(jack..'lock_markdown'..msg.chat_id_) then 
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.textEntityTypeTextUrl and redis:get(jack..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageUnsupported" and redis:get(jack..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessagePhoto" then
if redis:get(jack..'mute_photo'..msg.chat_id_)  then -- قفل الصور
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(jack..':tqeed_photo:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageVideo" then
if redis:get(jack..'mute_video'..msg.chat_id_) then -- قفل الفيديو
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(jack..':tqeed_video:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageDocument" and redis:get(jack..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageSticker" and redis:get(jack..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAnimation" then
if redis:get(jack..'mute_gif'..msg.chat_id_) then -- قفل المتحركه
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif redis:get(jack..':tqeed_gif:'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.content_.ID == "MessageContact" and redis:get(jack..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageLocation" and redis:get(jack..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageVoice" and redis:get(jack..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageGame" and redis:get(jack..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.ID == "MessageAudio" and redis:get(jack..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.reply_markup and  msg.reply_markup.ID == "replyMarkupInlineKeyboard" and redis:get(jack..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
and redis:get(jack..'lock_webpage'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.content_.caption_:match("@[%a%d_]+") and redis:get(jack..'lock_username'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(jack..'replay'..msg.chat_id_) then

GetUserID(msg.sender_user_id_,function(arg,data)
local Replay = false

Replay = redis:hget(jack..'replay:all',msg.text)
if Replay then
...
Replay = redis:hget(jack..'replay:'..msg.chat_id_,msg.text)
if Replay then 
Replay = convert_Klmat(msg,data,Replay,true)
sendMsg(msg.chat_id_,msg.id_,Flter_Markdown(Replay)) 
return false
...
Replay = redis:hget(jack..'replay_photo:group:',msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
...
Replay = redis:hget(jack..'replay_voice:group:',msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jack..'replay_animation:group:',msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jack..'replay_audio:group:',msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jack..'replay_sticker:group:',msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(jack..'replay_video:group:',msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
...
Replay = redis:hget(jack..'replay_photo:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendPhoto(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(jack..'replay_voice:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVoice(msg.chat_id_,msg.id_,Replay,Caption)
...
Replay = redis:hget(jack..'replay_animation:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAnimation(msg.chat_id_,msg.id_,Replay,Caption)  
...
Replay = redis:hget(jack..'replay_audio:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendAudio(msg.chat_id_,msg.id_,Replay,"",Caption)  
...
Replay = redis:hget(jack..'replay_sticker:group:'..msg.chat_id_,msg.text)
if Replay then 
sendSticker(msg.chat_id_,msg.id_,Replay)  
return false
end

Replay = redis:hget(jack..'replay_video:group:'..msg.chat_id_,msg.text)
if Replay then 
Caption = redis:hget(jack..':caption_replay:'..msg.chat_id_,msg.text)
Caption = convert_Klmat(msg,data,Caption)
sendVideo(msg.chat_id_,msg.id_,Replay,Caption)
...
if msg.text and redis:get(jack.."lock_rdodSource"..msg.chat_id_) then
...
if redis:get(jack..'CheckExpire::'..msg.chat_id_) then
local ExpireDate = redis:ttl(jack..'ExpireDate:'..msg.chat_id_)
SUDO_USER = redis:hgetall(jack..'username:'..SUDO_ID).username
if SUDO_USER:match('@[%a%d_]+') then 
